    ...
    public class SalesServices
    {
        ...
        public List<ProformaInvoice> ListProformaInvoice()
        {
            try
            {
                ...
                cmd.CommandText = "SELECT pi.ProformaInvoiceID, c.CustomerName, pi.PODate, pi.Status FROM ProformaInvoice pi JOIN Customers c ON c.CustomerID = pi.CustomerID WHERE Status='Pending'";
